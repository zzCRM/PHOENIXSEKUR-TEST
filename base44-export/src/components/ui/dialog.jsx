...
const DialogContent = React.forwardRef(({ className, children, onInteractOutside, onPointerDownOutside, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    <DialogPrimitive.Content
      ref={ref}
      onInteractOutside={(e) => {
        // Ne pas fermer en cliquant à côté de la fenêtre
        e.preventDefault();
        onInteractOutside?.(e);
      }}
