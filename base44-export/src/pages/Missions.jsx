...
export default function Missions() {
  ...
  const { data: missions = [], isLoading } = useQuery({ queryKey: ['missions', companyId], queryFn: () => base44.entities.Mission.filter({ company_id: companyId }, '-date', 100), enabled: !!companyId });
